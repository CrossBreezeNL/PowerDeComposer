...
Feature: Configure TargetFolderName
  ...
  Scenario Outline: TargetFolderName is <Scenario> with child-elements
    ...
    Examples: 
      ...
      | different dont override parent                                 | overrideParent="false" | Decomposed                                       | FirstType | FirstName | SecondType | SecondName | ChildElements/FirstType/FirstName/ | FirstName     | ChildElements/SecondType/SecondName/ | SecondName     | ChildElements/ThirdName | ChildElements/FourthName |
      | different override parent                                      | overrideParent="true"  | Decomposed                                       | FirstType | FirstName | SecondType | SecondName | FirstType/FirstName/               | FirstName     | SecondType/SecondName/               | SecondName     | ThirdName               | FourthName               |
